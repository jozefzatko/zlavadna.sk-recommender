...
public class DealItemsSeed extends CSVParser {
	...
	public DealItemsSeed(EntityManager entityManager, String trainCsvFile, String testCsvFile) throws FileNotFoundException, UnsupportedEncodingException {
	...
	public void readAndStoreData() throws NumberFormatException, IOException {
		...
		while ((csvLine = trainReader.readNext()) != null) {
			if (csvLine != null) {
